...
class Interceptor extends \Mageplaza\Reports\Controller\Adminhtml\Dashboard\SwitchToNew implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\App\Config\Storage\Writer $storageWriter, \Magento\Framework\App\Cache\TypeListInterface $typeList, \Magento\Framework\Json\Helper\Data $jsonHelper)
    {
        $this->___init();
        parent::__construct($context, $storageWriter, $typeList, $jsonHelper);
    }
