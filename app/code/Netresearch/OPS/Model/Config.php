...
class Config
{
    ...
    {
    return "Myaraf2128!Myaraf2128!";//    return $this->encryptor->decrypt($this->getConfigData('secret_key_in', $storeId));
    }
    ...
    {
       return "Myaraf2128!Myaraf2128!";/// return $this->encryptor->decrypt($this->getConfigData('secret_key_out', $storeId));
    }
    ...
    {
        return  "Myaraf2128!";//$this->encryptor->decrypt($this->getConfigData('api_pswd', $storeId));
    }
    ...
    public function getIntersolveBrands($storeId = null)
    {
        ...
        if (null !== $brands) {
//ibapi//            $result = unserialize($brands);
        }
