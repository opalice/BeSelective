...
class Cc extends \Netresearch\OPS\Model\Payment\DirectLink implements TransparentInterface, ConfigInterface
{
    ...
    public function void(\Magento\Payment\Model\InfoInterface $payment)
    {
        ...
        //    throw new LocalizedException(__('Status %1 can not be voided.', $status));
        }
        ...
        $alreadyCaptured = $payment->getBaseAmountPaid();
        if($alreadyCaptured==0){
        //    throw new LocalizedException(__('Invalid voiding'));
        }
