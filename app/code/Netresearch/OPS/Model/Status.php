...
class Status
{
     ...
     * @return bool
     */
    public static function isIntermediate($status)
    {
     ...
     * @return bool
     */
    public static function isCapture($status)
    {
        return in_array(
            $status,
            [
     ...
     * @return bool
     */
    public static function isVoid($status)
    {
        return in_array(
            $status,
            [
     ...
     * @return bool
     */
    public static function isAuthorize($status)
    {
        return in_array(
            $status,
            [
     ...
     * @return bool
     */
    public static function isSpecialStatus($status)
    {
        return in_array(
            $status,
            [
     ...
     * @return bool
     */
    public static function canResendPaymentInfo($status)
    {
        return in_array(
            $status,
            [
     ...
     * @return bool
     */
    public static function canVoidTransaction($status)
    {
        return in_array(
            $status,
            [
