...
class GenerateHash extends \Netresearch\OPS\Controller\Alias
{
    ...
    protected function generateHash($storeId)
    {
        ...
        $data['raw']=$raw;
        $hash=$this->getPaymentHelper()->shaCrypt($raw);
        $data['hash']=$hash;
        $data=json_encode($data);
        /*
         * Exception #0 (Exception): Notice: Undefined index: Alias_AliasId in /mnt/d/cdrom/m2/app/code/Netresearch/OPS/Controller/Alias/Accept.php on line 40
